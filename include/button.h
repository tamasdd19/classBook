...
#define SPACE_BETWEEN_BUTTONS 25
...
public:
    ...
    // options by changing the SPACE_BETWEEN_BUTTONS macro up. 25px is set by default
    ...
    void setText(const std::string&, const bool& setCenter);
    ...
    static void setButtonsTotalHeight(float height);
